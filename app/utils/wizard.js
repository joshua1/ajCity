...
(function($) {
    ...
    var $activeStep,$nextStep,$paginationBloc,$wizard,
        $formObj,prevStep,nextStep,currentStep,leftValue;
        ...
        init : function(options) {
                ...
                beforeSubmit: function(wizardObj) {
                    wizardObj.find('input, textarea').each(function() {
                        if(!this.checkValidity()) {
                            this.focus();
                            var step = $(this).parents('.'+thisSettings.stepClassName).attr('data-step');
            ...
            return this.each(function() {
                ...
                if(thisSettings.steps > 1) {
                   ...
                   var $stepsHtml = $('<ul class="easyWizardSteps">');
                    ...
                    $steps.each(function(index) {
                       ...
                       var stepText = thisSettings.stepsText.replace('{n}', '<span>'+step+'</span>');
                    ...
                    if(thisSettings.showButtons) {
                       var paginationHtml = '<div class="easyWizardButtons">';
